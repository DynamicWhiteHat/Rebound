...
## How It Works
The combination of the ADS1292 and AD5940 ICs allows the device to recognize when a swallow is "off beat". Trained on data provided by a UCLA study, the ADS1292 uses its sEMG abilities to monitor the activation of submental muscles that elevate the larynx to protect the airway during swallowing. Using a random forest algorithim, the device determines if the action performed was a swallow. By calculating the delta between the swallow and an objected detected in the throat by the AD5940 and running it through a one-class SVM, whether or not a silent aspiration was performed can be determined.

## BOM
|Part                       |Quantity            |Price                |Link                                                                                |FIELD5    |FIELD6   |FIELD7   |FIELD8                                            |
|---------------------------|--------------------|---------------------|------------------------------------------------------------------------------------|----------|---------|---------|--------------------------------------------------|
